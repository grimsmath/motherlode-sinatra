...
class NuggetsControllerTest < ActionController::TestCase
  ...
  test "should create nugget" do
    assert_difference('Nugget.count') do
      post :create, nugget: { author_id: @nugget.author_id, category_id: @nugget.category_id, content: @nugget.content, title: @nugget.title }
    end
  ...
  test "should update nugget" do
    patch :update, id: @nugget, nugget: { author_id: @nugget.author_id, category_id: @nugget.category_id, content: @nugget.content, title: @nugget.title }
    assert_redirected_to nugget_path(assigns(:nugget))
  end
